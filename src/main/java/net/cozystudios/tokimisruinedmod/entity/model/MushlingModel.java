...
import net.cozystudios.tokimisruinedmod.entity.animations.MushlingAnimations;
...
public class MushlingModel<T extends MushlingEntity> extends SinglePartEntityModel<T> {
    ...
    public void setAngles(MushlingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateMovement(MushlingAnimations.WALKING, limbSwing, limbSwingAmount, 2f, 2.5f);
    ...
    public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, int color) {
        mushling.render(matrices, vertexConsumer, light, overlay, color);
    }
